...
static const float kSCPianoRollHorizontalMinGridInterval = 50.0f;
static const float kSCPianoRollHorizontalMaxGridInterval = 400.0f;

static const float kSCPianoRollMinimumNoteWidth = 20.0f;
